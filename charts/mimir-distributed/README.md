...
To obtain a Grafana Enterprise Metrics license, refer to [Get a license](https://grafana.com/docs/enterprise-metrics/latest/setup/#get-a-gem-license).
...
Please consult the [migration guide](https://grafana.com/docs/enterprise-metrics/latest/) for details on how to prepare the configuration. Prepare a custom values file, with the contents:
