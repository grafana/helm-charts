...
![Version: 1.9.0](https://img.shields.io/badge/Version-1.9.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.6.1](https://img.shields.io/badge/AppVersion-2.6.1-informational?style=flat-square)
...
|-----|------|---------|-------------|
| enterprise.config | string | See values.yaml | Enterprise specific sections of the config.yaml file |
...
| enterprise.nginxConfig.file | string | see values.yaml | Enterprise Nginx config file |
...
| minio | object | see values.yaml | Configuration for `minio` child chart |
