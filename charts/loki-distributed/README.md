...
| compactor.startupProbe | object | `{}` | startup probe settings for compactor pods. If empty, use `loki.startupProbe` |
...
| gateway.startupProbe.failureThreshold | int | `3` |  |
| gateway.startupProbe.httpGet.path | string | `"/"` |  |
| gateway.startupProbe.httpGet.port | string | `"http"` |  |
| gateway.startupProbe.timeoutSeconds | int | `1` |  |
...
| loki.startupProbe.failureThreshold | int | `30` |  |
| loki.startupProbe.httpGet.path | string | `"/ready"` |  |
| loki.startupProbe.httpGet.port | string | `"http"` |  |
...
| memcached.startupProbe.failureThreshold | int | `1` |  |
| memcached.startupProbe.tcpSocket.port | string | `"http"` |  |
