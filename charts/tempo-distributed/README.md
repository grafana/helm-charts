...
| metricsGenerator.annotations | object | `{}` | Annotations for the metrics-generator Deployment |
...
| metricsGenerator.autoscaling.maxReplicas | int | `3` | Note that increasing the number of metrics-generated instances will increase the total active series. |
