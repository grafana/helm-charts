...
| ingester.config.maxBlockBytes | int | `nil` | Maximum size of a block before cutting it |
| ingester.config.maxBlockDuration | string | `nil` | Maximum length of time before cutting a block |
| ingester.config.completeBlockTimeout | string | `nil` | Duration to keep blocks in the ingester after they have been flushed |
