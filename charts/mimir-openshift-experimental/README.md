# Grafana Mimir Helm Chart for OpenShift (Experimental)
...
Grafana Mimir on OpenShift Experiment
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | memcached(memcached) | 6.0.16 |
| https://charts.bitnami.com/bitnami | memcached-queries(memcached) | 6.0.16 |
| https://charts.bitnami.com/bitnami | memcached-metadata(memcached) | 6.0.16 |
