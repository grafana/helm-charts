...
| metricsGeneration.buckets | list | `["0s","0.005s","0.01s","0.025s","0.05s","0.075s","0.1s","0.25s","0.5s","0.75s","1s","2.5s","5s","7.5s","10s"]` | List of histogram buckets. |
...
| metricsGeneration.expiration | string | `"0s"` | Time period after which metrics are considered stale and are removed from the cache. |
| metricsGeneration.flushInterval | string | `"15s"` | How often to flush generated metrics. |
