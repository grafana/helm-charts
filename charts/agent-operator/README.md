...
![Version: 0.3.1](https://img.shields.io/badge/Version-0.3.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.35.3](https://img.shields.io/badge/AppVersion-0.35.3-informational?style=flat-square)
...
| image.tag | string | `"v0.35.3"` | Image tag |
