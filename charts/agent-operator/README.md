...
![Version: 0.4.3](https://img.shields.io/badge/Version-0.4.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.43.2](https://img.shields.io/badge/AppVersion-0.43.2-informational?style=flat-square)
...
| image.tag | string | `"v0.43.2"` | Image tag |
